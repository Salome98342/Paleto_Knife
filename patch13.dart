...
''';
    ...
    // Also change enemySize logic
    if (c.contains('final enemySize = isBoss ? 100.0 : 80.0;')) {
         c = c.replaceFirst('final enemySize = isBoss ? 100.0 : 80.0;', 'final enemySize = enemy.size;');
    }
