...
class CombatScreen extends StatefulWidget {
  ...
  const CombatScreen({super.key, required this.gameController});
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _combatController.initialize(
        ...
        chefController: Provider.of<ChefController>(context, listen: false),
      );
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'Dificultad: x${world.difficultyMultiplier.toStringAsFixed(1)}',
            ),
            ...
            SafeArea(
              child: Padding(
                ...
                child: Container(
                  ...
                  decoration:
                      const BoxDecoration(), // Quitamos el marco gris opaco
                  child: Column(
                    children: [
