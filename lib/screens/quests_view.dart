...
class _QuestsViewState extends State<QuestsView> {
  ...
  Widget _buildQuestCard({
    ...
    return Container(
      ...
      decoration:
          RetroStyle.box(
            color: isClaimed ? Colors.grey.shade400 : RetroStyle.panel,
          ).copyWith(
            border: Border.all(
              color: isClaimed
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isGems ? Colors.purpleAccent : Colors.yellow,
                    width: 2,
                  ),
                ),
                child: Row(
                  ...
                  children: [
                    Icon(
                      isGems ? Icons.diamond : Icons.monetization_on,
                      size: 14,
                      color: isClaimed
                          ? Colors.grey
                          : (isGems ? Colors.purpleAccent : Colors.yellow),
                    ),
