...
class EnemyComponent extends PositionComponent
  ...
  void spawn(
    ...
    if (isBoss) {
      ...
      velocity.y = velocity.y
          .abs(); // Asegurar de que baja rapido la primera vez hacia la zona top
      velocity.x =
          velocity.x.abs() * 1.5; // Movimiento horizontal mas rapido arriba
    }
  ...
  void _executeBossAdvancedPattern() {
    ...
    if (healthRatio > 0.6) {
      ...
      final dir1 = Vector2(
        cos(_currentRotation * 2),
        sin(_currentRotation * 2),
      );
      final dir2 = Vector2(
        cos(-_currentRotation * 2),
        sin(-_currentRotation * 2),
